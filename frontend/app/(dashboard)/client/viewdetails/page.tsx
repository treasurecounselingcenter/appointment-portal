  ...
  if (!appointment)
    return (
      <div className="rounded-lg border border-[#c1c9c0] bg-white p-6 shadow-sm">
        <h2 className="mb-4 font-[var(--font-source-serif)] text-2xl text-[#1a1c1a]">Client not found</h2>
        <button
...
export default function ClientViewDetailsPage() {
  return (
    <Suspense
      fallback={<div className="rounded-lg border border-[#c1c9c0] bg-white p-6 text-[#414942]">Loading client details...</div>}
    >
      <ClientDetailsRoute />
    </Suspense>
  );
